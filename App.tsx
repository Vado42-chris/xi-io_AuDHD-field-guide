...
/**
 * SUB-VIEWS (Omitted for brevity - same as previous version but required for full file)
 */
...
const Icons = {
  ...
  Journal: () => <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9M16.5 3.5a2.121 2.121(2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"/></svg>,
